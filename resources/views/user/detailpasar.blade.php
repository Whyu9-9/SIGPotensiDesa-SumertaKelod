                    ...
                    <div class="tab-pane active" id="other">
                        <div class="list-group">
                            @forelse($list as $l)
                                ...
                                @else
                                    <a href="/loadDataPasar/{{$l->id}}" data-toggle="modal" class="list-group-item "> 
                                        <h4 class="list-group-item-heading" ><i class="fas fa-balance-scale"></i> {{$l->nama_pasar}}</h4>
                ...
                <div class="panel-body">
                    ...
                    <div class="col-xs-6">
                        <div class="row point-info">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <img src="{{asset('img/'.$pasar->foto)}}" class="mb-3" style="border:solid #000 3px;width:100%;" id="propic">
                                </div>
                            </div>
                        </div>
                    </div>
