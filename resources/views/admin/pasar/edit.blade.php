        ...
        <div class="row">
            ...
            <div class="col-md-4 col-12">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form action="{{ route('pasar.update',$pasar->id) }}" id="form-desa" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="fotopasar" name="fotopasar" onchange="this.nextElementSibling.innerText = this.files[0].name">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama_pasar" placeholder="Masukkan nama Pasar" required value="{{$pasar->nama_pasar}}">
                                <small style="color: red">
                                    @error('nama_pasar')
                                        {{$message}}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="lat" id="lat" readonly required value="{{$pasar->lat}}">
                                <small style="color: red">
                                    @error('lat')
                                        {{$message}}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="lng" id="lng" readonly required value="{{$pasar->lng}}">
                                <small style="color: red">
                                    @error('lng')
                                        {{$message}}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="alamat" placeholder="Masukkan alamat Pasar" required value="{{$pasar->alamat}}">
                                <small style="color: red">
                                    @error('alamat')
                                        {{$message}}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="telepon" placeholder="Masukkan telepon Pasar" required value="{{$pasar->telepon}}">
                                <small style="color: red">
                                    @error('telepon')
                                        {{$message}}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <textarea placeholder="Masukan Keterangan" name="keterangan" cols="30" rows="4" class="form-control" required>{{$pasar->keterangan}}</textarea>
                                <small style="color: red">
                                    @error('keterangan')
                                        {{$message}}
                                    @enderror
                        ...
                        <a href="/admin/potensi/pasar"><button type="button" class="btn btn-danger float-left mr-2"><i class="fas fa-times"></i> Kembali</button></a>
                        </form>
                    </div>
                </div>
            </div>
