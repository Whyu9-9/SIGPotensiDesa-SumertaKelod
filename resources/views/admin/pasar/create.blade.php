        ...
        <div class="row">
            ...
            <div class="col-md-4 col-12">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form action="{{ route('pasar.store') }}" id="form-desa" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <div align="center" class='col'>
                                        <img src="{{asset('img/pasar.png')}}" class="mb-3" style="border:solid #000 3px;height:60%;width:80%;" id="propic">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama_pasar" placeholder="Masukkan nama pasar" required value="{{$errors->any() ? old('nama_pasar') : ''}}">
                                <small style="color: red">
                                    @error('nama_pasar')
                                        {{$message}}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="alamat" placeholder="Masukkan alamat pasar" required value="{{$errors->any() ? old('alamat') : ''}}">
                                <small style="color: red">
                                    @error('alamat')
                                        {{$message}}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="telepon" placeholder="Masukkan telepon pasar" required value="{{$errors->any() ? old('telepon') : ''}}">
                                <small style="color: red">
                                    @error('telepon')
                                        {{$message}}
                                    @enderror
