                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama_tempat_ibadah" placeholder="Masukkan nama tempat ibadah" disabled value="{{$tempatibadah->nama_tempat_ibadah}}">
                                <small style="color: red">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="lat" id="lat" readonly value="{{$tempatibadah->lat}}">
                                <small style="color: red">
                                    @error('lat')
                                        {{$message}}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="lng" id="lng" readonly value="{{$tempatibadah->lng}}">
                                <small style="color: red">
                                    @error('lng')
                                        {{$message}}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="alamat" placeholder="Masukkan alamat tempat ibadah" disabled value="{{$tempatibadah->alamat}}">
                                <small style="color: red">
                                    @error('alamat')
                                        {{$message}}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <textarea placeholder="Masukan Keterangan" name="keterangan" cols="30" rows="4" class="form-control" disabled>{{$tempatibadah->keterangan}}</textarea>
                                <small style="color: red">
                                    @error('keterangan')
                                        {{$message}}
                                    @enderror
