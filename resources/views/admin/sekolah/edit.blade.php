        ...
        <div class="row">
            ...
            <div class="col-md-4 col-12">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form action="{{ route('sekolah.update',$sekolah->id) }}" id="form-desa" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="fotosekolah" name="fotosekolah" onchange="this.nextElementSibling.innerText = this.files[0].name">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nama_sekolah" placeholder="Masukkan nama sekolah" required value="{{$sekolah->nama_sekolah}}">
                                <small style="color: red">
                                    @error('nama_sekolah')
                                        {{$message}}
                                    @enderror
                            ...
                            <div class="form-group form-group mt-3">
                                ...
                                <select class="form-control" id="jenis" rows="3" name="jenis_sekolah" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="lat" id="lat" readonly required value="{{$sekolah->lat}}">
                                <small style="color: red">
                                    @error('lat')
                                        {{$message}}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="lng" id="lng" readonly required value="{{$sekolah->lng}}">
                                <small style="color: red">
                                    @error('lng')
                                        {{$message}}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="alamat" placeholder="Masukkan alamat sekolah" required value="{{$sekolah->alamat}}">
                                <small style="color: red">
                                    @error('alamat')
                                        {{$message}}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="telepon" placeholder="Masukkan telepon sekolah" required value="{{$sekolah->telepon}}">
                                <small style="color: red">
                                    @error('telepon')
                                        {{$message}}
                                    @enderror
                            ...
                            <div class="form-group">
                                ...
                                <textarea placeholder="Masukan Keterangan" name="keterangan" cols="30" rows="4" class="form-control" required>{{$sekolah->keterangan}}</textarea>
                                <small style="color: red">
                                    @error('keterangan')
                                        {{$message}}
                                    @enderror
                        ...
                        <a href="/admin/potensi/sekolah"><button type="button" class="btn btn-danger float-left mr-2"><i class="fas fa-times"></i> Kembali</button></a>
                        </form>
                    </div>
                </div>
            </div>
