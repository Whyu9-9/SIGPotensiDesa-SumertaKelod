...
<div class="container-fluid">
    ...
    <div class="col-12 col-xs-12 col-md-12">
        ...
        <!-- /.card-header -->
        <div class="card-body">
            <span><a href="/admin/kabupaten/create" class="btn btn-success mb-4"><i class="fas fa-plus"></i> Tambah Data Kabupaten</a></span>
                ...
                <tr>
                    ...
                    <td width="20%" align="center">
                        <div class="d-flex align-items-center">
                            <a style="margin-right:7px" class="btn btn-info btn-sm" href="{{ route('kabupaten.edit', $k->id) }}" ><i class="fas fa-pencil-alt" ></i> Edit</a>
